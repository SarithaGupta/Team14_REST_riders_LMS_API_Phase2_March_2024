...
//Check if admin is able to get the Admins by program batches for invalid batch ID
	...
	public void admin_receives_status_with_not_found_error_message_for(Integer int1, String scenario) throws IOException {
...
//Check if admin is able to get the Admins by program batches for valid batch ID with no authorization 
	...
	public void admin_receives_status_with_unauthorized_message_for(Integer int1, String scenario) throws IOException {
...
//Check if admin is able to retreive Admins by invalid role ID	
	...
	public void admin_receives_not_found_status_with_message_and_boolean_success_details_for(Integer int1, String scenario) throws IOException {
